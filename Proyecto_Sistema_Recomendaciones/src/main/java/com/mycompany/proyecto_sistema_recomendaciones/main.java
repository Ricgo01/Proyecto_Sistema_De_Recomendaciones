...
public class main {
    ...
    private static String seleccionarTamaño(int opcion) {
        switch (opcion) {
            ...
            default: return "Mediano"; // default case to handle unexpected inputs
        }
    }
    ...
    private static String seleccionarColor(int opcion) {
        switch (opcion) {
            ...
            default: return "Blanco"; // default case to handle unexpected inputs
        }
    }
    ...
    private static String seleccionarPelo(int opcion) {
        switch (opcion) {
            ...
            default: return "Corto"; // default case to handle unexpected inputs
        }
    }
    ...
    private static String seleccionarPersonalidad(int opcion) {
        switch (opcion) {
            ...
            default: return "Sociable/Amigable"; // default case to handle unexpected inputs
        }
    }
    ...
    private static String seleccionarClima(int opcion) {
        switch (opcion) {
            ...
            default: return "Adaptable"; // default case to handle unexpected inputs
        }
    }
}